    ...
    <SafeAreaView style={[styles.container, { backgroundColor: dashboardBg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.btnRow}>
          ...
          <TouchableOpacity
            style={[styles.primaryActionBtn, { backgroundColor: '#1A237E' }]}
            onPress={() => navigation.navigate('CryptoDemo' as never)}
          >
            <Text style={styles.actionBtnIcon}>🔐</Text>
            <Text style={styles.actionBtnText}>PQ Crypto Demo</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
